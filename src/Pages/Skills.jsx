...
const Skills = () => {
  ...
  return (
    <div
      id="skills"
      style={
        (mob.width > 800) & (mob.width < 1300)
          ? { marginTop: "150px", paddingTop: "60px" }
          : { marginTop: "" }
      }
      className="my-20 md:mt-80 sm:mb-8 sm:p-4 sm:mt-0"
    >
      <h1
        style={(mob.width > 800) & (mob.width < 1300) ? { paddingTop: 0 } : {}}
        className="text-center text-5xl font-black pt-32 sm:pt-6 sm:mt-8"
      >
        Skills.
      </h1>
      <Tech />
